...
rootElement.innerHTML = `
  <div style="padding:24px;max-width:900px;margin:0 auto;font-family:Trebuchet MS,system-ui,sans-serif;color:#2f261b">
    <h1 style="color:#25486f;text-shadow:2px 2px 0 #fff">Bibliothèque des jeux</h1>
    <p>Chargement des aventures...</p>
  </div>
`

import('./GameLibrary.jsx')
  .then(({ default: GameLibrary }) => {
  ...
  .catch((error) => {
    rootElement.innerHTML = `
      <div style="padding:24px;max-width:900px;margin:0 auto;font-family:Trebuchet MS,system-ui,sans-serif;color:#2f261b">
        <h1 style="color:#25486f;text-shadow:2px 2px 0 #fff">Bibliothèque des jeux</h1>
        <p>Impossible de charger les jeux.</p>
